...
'''def build_diag_mermaid(project_name: str):
    discovery_server_data = pd.read_csv(
        f"diag_
data/{project_name}/discovery-server.csv", header=None, skiprows=1)
    discovery_clients_data = pd.read_csv(
        f"diag_
data/{project_name}/discovery-clients.csv", header=None, skiprows=1)
    load_balanced_requesters_data = pd.read_csv(
        f"diag_
data/{project_name}/eureka-load-balanced.csv", header=None, skiprows=1)
